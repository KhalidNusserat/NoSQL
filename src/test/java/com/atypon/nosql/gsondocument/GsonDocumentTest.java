...
class GsonDocumentTest {
    ...
    public void match() {
        JsonObject person = new JsonObject();
        person.addProperty("name", "Khalid");
        GsonDocument matchName = GsonDocument.fromJsonObject(person);
        person.addProperty("age", 18);
        GsonDocument matchNameAndAge = GsonDocument.fromJsonObject(person);
        JsonObject university = new JsonObject();
        university.addProperty("name", "Yarmouk");
        university.addProperty("rating", 3);
        person.add("university", university);
        GsonDocument matchEverything = GsonDocument.fromJsonObject(person);
        GsonDocument khalid = GsonDocument.fromJsonObject(person);
        ...
        GsonDocument matchOtherName = GsonDocument.fromJsonObject(otherPerson);
        otherPerson.addProperty("age", "42");
        GsonDocument matchOtherNameAndAge = GsonDocument.fromJsonObject(otherPerson);
        otherPerson.add("university", university);
        GsonDocument matchOtherEverything = GsonDocument.fromJsonObject(otherPerson);
        GsonDocument otherPersonDocument = GsonDocument.fromJsonObject(otherPerson);

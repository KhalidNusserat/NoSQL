...
public class SecurityConfiguration {
    private final DatabaseUsersService databaseUsersService;
    ...
    public SecurityConfiguration(
            DatabaseUsersService databaseUsersService,
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        daoAuthenticationProvider.setUserDetailsService(databaseUsersService);
